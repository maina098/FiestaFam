...
async function main() {
    ...
    for (const category of categoriesData) {
        ...
        const itemsToCreate = category.items.map((item) => {
            ...
            if (item.name === 'Buffalo Wings' || item.name === 'Chicken Wings' || item.name === 'Sichuan Sizzle Wings')
                imageUrl = '/assets/images/menu/chicken-wings.jpg';
            if (item.name === 'Lamb Chops')
                imageUrl = '/assets/images/menu/roast-lamb-chops.jpg';
            if (item.name === 'Sticky Toffee Temptation')
                imageUrl = '/assets/images/menu/sticky-toffee.jpg';
            if (item.name === 'Blissful Beef Duo')
                imageUrl = '/assets/images/menu/beef-burger.jpg';
            return {
                name: item.name,
                price: item.price,
